...
class McccDir(models.Model):
    ...
    last_nm = models.CharField(db_column='Last_NM', max_length=30, blank=True, primary_key=True, verbose_name="last name")  # Field name made lowercase.
    ...
    cell_phone = models.CharField(db_column='Cell_Phone', max_length=83, blank=True)  # Field name made lowercase.
