...
class UpdateInviteAdmin(admin.ModelAdmin):
    list_display = ('id','update_family','invite_state','invite_person','invite_email', 'access_token','expiration_date', 'address','home_phone','worship','last_nm1','first_nm1', 'chinese_nm1', 'cell_phone1', 'first_nm2', 'chinese_nm2', 'cell_phone2','creation_date',)
