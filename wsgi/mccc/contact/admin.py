...
class UpdateInviteAdmin(admin.ModelAdmin):
    list_display = ('id','update_family', 'access_token','invite_state','invite_person','invite_email','address','home_phone','worship','last_nm1','first_nm1', 'chinese_nm1', 'cell_phone1', 'first_nm2', 'chinese_nm2', 'cell_phone2',)
