...
class UpdateInviteAdmin(admin.ModelAdmin):
    list_display = ('id','dir_type','invite_email','invite_state', 'access_token','expiration_date', 'address','home_phone','worship','person1','last_nm1','first_nm1', 'chinese_nm1', 'cell_phone1','email1','person2', 'first_nm2', 'chinese_nm2', 'cell_phone2','email2','creation_date','comment',)
